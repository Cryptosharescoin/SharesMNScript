...
echo "Your CRYPTOSHARES Masternode Will be Updated To The Latest Version v2.0.1 Now" 
...
mkdir SHARES_2.0.1
cd SHARES_2.0.1
wget https://github.com/Cryptosharescoin/shares/releases/download/v2.0.1/shares-2.0.1-linux.tar.gz
tar -xzvf shares-2.0.1-linux.tar.gz
...
cd ~/.shares/
wget https://github.com/Cryptosharescoin/shares/releases/download/v2.0.1/bootstrap.zip
unzip bootstrap.zip

cd ..
rm -rf ~/.shares/bootstrap.zip ~/SHARES_2.0.1
