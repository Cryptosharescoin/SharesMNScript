#!/bin/bash
# CRYPTOSHARES Masternode Setup Script V2.3.0 for Ubuntu 16.04 LTS
#
...
wget https://github.com/Cryptosharescoin/shares/releases/download/v2.3.0/shares-2.3.0-linux-16.04.tar.gz
tar -xzvf shares-2.3.0-linux-16.04.tar.gz
...
cd ~/.shares && https://github.com/Cryptosharescoin/shares/releases/download/v2.3.0/bootstrap.zip
