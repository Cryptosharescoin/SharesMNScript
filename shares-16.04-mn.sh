#!/bin/bash
# CRYPTOSHARES Masternode Setup Script V2.2.0 for Ubuntu 16.04 LTS
#
...
echo -e "${GREEN} ------- CRYPTOSHARES MASTERNODE INSTALLER V2.2.0--------+
 |                                                  |
 |                                                  |::
...
cd ~/.shares && https://github.com/Cryptosharescoin/shares/releases/download/v2.2.0/bootstrap.zip
