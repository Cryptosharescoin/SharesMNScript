...
echo "Your CRYPTOSHARES Masternode Will be Updated To The Latest Version v1.2.0 Now" 
...
cd ~/.cryptoshares/
wget https://github.com/Cryptosharescoin/shares/releases/download/1.2.0/bootstrap.zip
unzip bootstrap.zip

cd ..
rm -rf ~/.cryptoshares/bootstrap.zip ~/SHARES_1.2.0
