...
wget https://github.com/Cryptosharescoin/shares/releases/download/2.0.1/shares-2.0.1-linux.tar.gz
...
cd ~/.shares && wget https://github.com/Cryptosharescoin/shares/releases/download/2.0.1/bootstrap.zip
