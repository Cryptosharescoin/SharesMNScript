#!/bin/bash
# CRYPTOSHARES Masternode Setup Script V2.0.1 for Ubuntu LTS
#
...
cd ~/.shares && wget https://github.com/Cryptosharescoin/shares/releases/download/v2.0.1/bootstrap.zip
